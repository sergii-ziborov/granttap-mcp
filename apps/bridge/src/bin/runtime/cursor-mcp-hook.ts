...
import { decisionToCursorOutput } from "../../host/adapters";
import { isUnanswered, requestApproval } from "../../approvals";
import {
...
} from "../../providers/cursor-mcp-policy";
import { recordAttributedCall } from "../../mesh/identity/call-scope";
...
import { protectedGrantTapAccess } from "../../host/self-protection";
import { readStdin, nativeAsk, deny } from "../hooks/shared/cursor-output";
