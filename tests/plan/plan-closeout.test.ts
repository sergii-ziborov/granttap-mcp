...
import { evaluateCreateTask, resolveCreateTaskProject } from "../../apps/bridge/src/mesh/tasks/create-task";
import {
  currentInstanceEpoch, pairingKeysPresent, recoverInstanceAfterRestore, remintInstanceEpoch,
} from "../../apps/bridge/src/host/instance-epoch";
import { parseInviteArgs, readInvite } from "../../apps/bridge/src/mesh/handoff/invite-source";
import { affectedRecipients } from "../../apps/bridge/src/mesh/delivery/affected-recipients";
import { persistBroadcast, recordTargetState, loadBroadcast } from "../../apps/bridge/src/mesh/delivery/broadcast-ledger";
import { capabilityManifest } from "../../apps/bridge/src/mesh/catalog/manifest";
import { renderContextDelta } from "../../apps/bridge/src/mesh/context/delta";
import { recordDelegation } from "../../apps/bridge/src/mesh/handoff/delegation-loop";
import { advanceBroadcast, planBroadcast } from "../../apps/bridge/src/mesh/delivery";
import { aliasFor, endpointIdFromAlias, setDeviceAlias } from "../../apps/bridge/src/mesh/identity/device-alias";
import {
  admitNewTask,
  applyHostGrant,
  loadExecutionPolicy,
...
import { renderCompactProjectContext } from "../../apps/bridge/src/mesh/context/project";
import type { ScopedMeshView } from "../../apps/bridge/src/mesh/snapshot/scoped-view";
import { dueQueuedTasks, enqueuePinnedTask } from "../../apps/bridge/src/mesh/tasks/queue";
import {
